...
${CMTROOT}/mgr/cmt setup -sh -pack=TestTPCECalSystematics -version=v0r0 -path=/home/epp/phrdqd/ND280/v11r31p5/highland2Systematics  -no_cleanup $* >${tempfile}; . ${tempfile}
/bin/rm -f ${tempfile}
