{
   ...
   std::string isBr = "entersBarrel";
   // Appears to enter downstream based on cuts
   std::string isDS = "entersDownstream";
   ...
   std::string isMuon = "isMuonLike";
   std::string isProton = "isProtonLike";
   ...
   draw.Draw(mc, mc, momentum, nds_mom, ds_bins_mom, "particle", isDS + " && " + isMuon);
}
